			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsdmsviewer-display": {
								"semanticObject": "nsdmsviewer",
								"action": "display",
								"description": "DMS Management App",
								"title": "DMS maintenance",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.dmsviewer",
									"url": sap.ui.require.toUrl("ns/dmsviewer")
								}
							}
						}
					}
